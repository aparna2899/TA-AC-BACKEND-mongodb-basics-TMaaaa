...
mongoimport --db test --collection users --type=json --file Desktop/user.json --jsonArray
...
mongoimport -d test -c students --type csv --file Desktop/student.csv --headerline
